...
public class TextViewMitraBold extends TextView {

	Context ctx;

	public TextViewMitraBold(Context context) {
		super(context);
...
//		setColor();
	...
	public TextViewMitraBold(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (!isInEditMode()) {
			setFont();
		}
//		setColor();
	...
	public TextViewMitraBold(Context context, AttributeSet attrs, int defStyle) {
