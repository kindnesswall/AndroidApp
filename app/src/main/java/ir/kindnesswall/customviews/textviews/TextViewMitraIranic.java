...
public class TextViewMitraIranic extends TextView {

	Context ctx;

	public TextViewMitraIranic(Context context) {
		super(context);
...
//		setColor();
	...
	public TextViewMitraIranic(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (!isInEditMode()) {
			setFont();
		}
//		setColor();
	...
	public TextViewMitraIranic(Context context, AttributeSet attrs, int defStyle) {
