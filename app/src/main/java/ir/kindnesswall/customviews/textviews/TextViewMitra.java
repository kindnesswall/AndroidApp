...
public class TextViewMitra extends TextView {

	Context ctx;

	public TextViewMitra(Context context) {
		super(context);
...
//		setColor();
	...
	public TextViewMitra(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (!isInEditMode()) {
			setFont();
		}
//		setColor();
	...
	public TextViewMitra(Context context, AttributeSet attrs, int defStyle) {
