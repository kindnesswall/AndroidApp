 ...
 */
public class TapsellListItemAdHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
	...
	public TapsellListItemAdHolder(View itemView, Context context) {
		...
		nativeBannerViewManager = new TapsellNativeBannerManager.Builder()
				...
				.setContentViewTemplate(R.layout.row_gift_tapsell_ad)
