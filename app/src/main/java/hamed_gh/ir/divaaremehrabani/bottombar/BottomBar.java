...
import hamed_gh.ir.divaaremehrabani.bottombar.scrollsweetness.BottomNavigationBehavior;
...
public class BottomBar extends RelativeLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mWhiteColor == null) {
            ...
            mPrimaryColor = ContextCompat.getColor(getContext(), R.color.white);
//            mPrimaryColor = MiscUtils.getColor(getContext(), R.attr.colorPrimary);
            mInActiveColor = ContextCompat.getColor(getContext(), R.color.white);
